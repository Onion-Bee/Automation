...
if __name__ == '__main__':
    # Optionally customize subject here or pass via environment variable
    email_subject = os.getenv('EMAIL_SUBJECT', 'Quick Follow-Up from Our Event')
    send_emails(subject=email_subject)
